...
write.csv(normalized_df, paste0(current_date, "_pCIAPOD_Sox10IF_Otic.csv"))
```
...
boxplot <- ggplot(normalized_df, aes(x = Treatment, y = Ratio)) +
  ...
  geom_beeswarm(color = "black", 
                fill = "darkgray", 
                alpha = 1, shape = 21, size = 3, cex=7) +
  ylim(0, 1.3) + # Define Y axis upper and lower limits
