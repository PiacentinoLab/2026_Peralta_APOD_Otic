...
measure_channel_1 = 2
measure_channel_1_name = "SOX8"
measure_channel_2 = 4
measure_channel_2_name = "APOD" 
...
waitForUser("Drag ROI over Control Tissue, then press ok");
roiManager("Add");
roiManager("Select",0);
roiManager("Rename","Cntl");
roiManager("Show All");
makeOval(0, 0, 225, 225);
waitForUser("Drag ROI over Experimental Tissue, then press ok");
roiManager("Add");
roiManager("Select",1);
...
roiManager("Show All");
run("Flatten", "slice");
saveAs("JPEG", roi_dir+name+"_"+measure_channel_2_name+"_ROIOverlay.jpg");
