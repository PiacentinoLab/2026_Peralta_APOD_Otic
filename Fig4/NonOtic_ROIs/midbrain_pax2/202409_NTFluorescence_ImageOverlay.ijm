...
waitForUser("rotate image then hit ok");
...
//Define ROIs
makeRectangle(0, 0, 100, 250);
waitForUser("Drag ROI over Control NT, then press ok");
roiManager("Add");
roiManager("Select",0);
roiManager("Rename","Cntl");
roiManager("Show All");
makeRectangle(0, 0, 100, 250);
waitForUser("Drag ROI over Experimental NT, then press ok");
roiManager("Add");
roiManager("Select",1);
